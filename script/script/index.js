...
const LinksNav2=document.querySelectorAll("#offcanvasRight ul li a");
 ...
 sections.forEach((section,i)=>{
    ...
    if(sectionPostion >= sectionTop && sectionPostion < sectionBottom){
      ...
      links[i].classList.add("active") //add active class to current section
        ...
        LinksNav2.forEach(link => link.classList.remove("active") ) 
         // remove active class from all links
        LinksNav2[i].classList.add("active") //add active class to current section
